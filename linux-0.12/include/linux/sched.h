...
/* pid etc.. */	0,0,0,0, \
/* suppl grps*/ {NOGROUP,}, \
/* proc links*/ &inittask.task,0,0,0, \
/* uid etc */	0,0,0,0,0,0, \
...
/*tss*/	{0,PAGE_SIZE+(long)&inittask,0x10,0,0,0,0,(long)&pg_dir,\
	 0,0,0,0,0,0,0,0, \
...
extern struct task_struct *lasttask_used_math;
